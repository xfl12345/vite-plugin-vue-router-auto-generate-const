...
/** 生成文件的头部注释，用于抑制代码格式化工具和提供使用说明 */
export const GENERATED_FILE_HEADER = `/* eslint-disable */
/* prettier-ignore */
// oxfmt-ignore
...
export function generateConstContent(routeNames: string[]): string {
  if (routeNames.length === 0) {
    return `${GENERATED_FILE_HEADER}import type { RouteNamedMap } from 'vue-router/auto-routes'
